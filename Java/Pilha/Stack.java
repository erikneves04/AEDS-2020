/**
 * A stack made from a doubly linked list.
 * @author Erik Neves
...
public class Stack<DataType>{  
    ...
    */
    ...
    /**
     * Method responsible for add new data at the end of the stack.
    ...
    */
    ...
    /**
     * Method responsible for remove the last item from a stack
    ...
    */
    public DataType remove() throws IllegalStateException{
        ...
        DataType DadosItem;
        ItemLista<DataType> DadosLista = this.primeiro;
        for(int i=0;i<this.NumeroDeItens;i++){if(DadosLista.GetProximo() != null)DadosLista = DadosLista.GetProximo();}
        
        DadosItem = DadosLista.GetDadosItem();
        
        if(DadosLista.equals(this.primeiro)){
            this.primeiro = this.primeiro.GetProximo();
            if(this.primeiro != null)this.primeiro.SetAnterior(null);
        }else{
            DadosLista.GetAnterior().SetProximo(null);
        }
