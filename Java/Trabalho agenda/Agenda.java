...
/**
 *                  Classe de uma agenda, responsavel pelas interações com o usuario.
...
public class Agenda {
    ...
    /**
     * HashMap responsavel por amazenar os registros que compoem essa agenda.
     */
    private final HashMap<String,Registro> DadosAgenda = new HashMap<>();
    ...
    public void AdicionarRegistro(){
        ...
        while(!DadosValidos){
            ...
            if(this.DadosAgenda.containsKey(identificacao)){
        ...
        this.DadosAgenda.put(NovoRegistro.GetIdentificacao(), NovoRegistro);
    ...
    public void ApagarRegistro(){
        ...
        while(!IdentificacaoExistente){
            ...
            if(this.DadosAgenda.containsKey(Alvo)){
        ...
        Registro DadoAlvo = this.DadosAgenda.get(Alvo);
     ...
     */
    public void ImprimirInfos_B(){
        
        System.out.println("+------------------------------------------------+");
        System.out.println("| Informacoes basicas dos contatos dessa agenda: |");
        System.out.println("+------------------------------------------------+");
        
        Registro[] ArrayReg = new Registro[this.DadosAgenda.values().size()];
        this.DadosAgenda.values().toArray(ArrayReg);
    ...
    public void AlterarDados(){
        ...
        while(EscolhaDoUsuario != 0){
            ...
            switch(EscolhaDoUsuario){
                ...
                break;
                case 5:
                    this.ImprimirTelefonesDeUmContato(DadoAlvo.ObtemTelefones());
                break;
                case 6:
                ...
                case 7:
                    ...
                    if(EscolhaDoUsuario == 0){
                        this.ImprimirEnderecosDeUmContato(DadoAlvo.ObtemEnderecos());
                    }
     ...
     */
    private void ImprimirTelefonesDeUmContato(String[] Telefones){
        System.out.println("\t+-------------------------------------+");
     ...
     */
    private void ImprimirEnderecosDeUmContato(EnderecoContainer[] Enderecos){
        System.out.println("\t+-------------------------------------+");
